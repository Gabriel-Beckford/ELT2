...
export async function generateImage(prompt: string, model: string = 'gemini-3.1-flash-image-preview', options: any = {}): Promise<{ data: string; mimeType: string } | undefined> {
  try {
